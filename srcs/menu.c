...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/10 16:34:41 by vduran-m          #+#    #+#             */
/*   Updated: 2025/06/20 16:51:34 by vduran-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_menu(t_fdf *fdf)
{
	...
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, "Move: press arrow keys");
	...
	mlx_string_put(mlx, win, 50, y += 20, C_TEXT, "Zoom: press '-' or '+'");
	mlx_string_put(mlx, win, 50, y += 20, C_TEXT, "Colors: press 'SPACE'");
	mlx_string_put(mlx, win, 50, y += 35, C_TEXT, projection);
